...
zstyle :compinstall filename '/home/cpunk/.zshrc'
zstyle ':completion:*' list-colors 'gxBxhxDxfxhxhxhxhxcxcx'
...
export PATH="$PATH:$HOME/opt/dax"

export PS1="[%n@%m: %d] %# "
# solarized ansi-universal dircolors - https://github.com/seebi/dircolors-solarized
...
alias digo-rs='ssh -R 0.0.0.0:4444:127.0.0.1:4444 user@punkn.cpunkn.com'
...
#    /usr/local/bin/docker "$1" --platform linux/x86_64/v8 "${@:2}"
#  else
