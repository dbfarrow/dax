...
#       return raw_input("Enter a password for the dax container:")
        dax_print(f"[-]   if you tire of typing in a password for dax, put it in {pwfile} and set the permissions to 0600... then try again")
        return getpass.getpass("Enter a password for the dax container:")
